    ...
    <div class="float-div">
        ...
        <div class="content">
            ...
            <div class="one-area">
                ...
                <p>特别说明：月度收益率排名前三即可获得月度奖励，无需账户整体收益为正。例如：2018年11月30日，假设参赛选手账户金融总资产仅为20万（因为前1个月亏损了），到了2018年12月31日，参赛选手账户金融总资产为25万，那么En=(25—20) ÷20×100%=25%。如果25%能排名在前三，虽然账户总资产低于30万，也可以参加月度排名，获得月度收益奖。</p>
            </div>
            <div class="one-area">
                <h3 class="title width-220">比赛账户仓位及交易品种限制</h3>
                <p>1、比赛A股账户不限制仓位，也不限制交易品种。</br>2、比赛成绩的计算依据是参赛选手真实参赛账户内的所有金融资产之和（不包含该账户持有的新三板股票以及已经退市的股票）。</br>3、参赛账户如果因为资产增值符合融资融券条件，并且在券商处开通了融资融券业务，融资融券产生的股票收益不计入参赛成绩。</br>4、参赛账户如果因为资产增值符合开通沪港通条件，并且在券商处开通了沪港通业务，沪港通产生的股票收益不计入参赛成绩。</br>5、为保证公平公正，参赛选手的参赛账户如果因为新股申购产生的打新收益，产生的打新收益不计入参赛成绩。（直接在二级市场上买卖新股产生的收益正常计入比赛成绩）。</p>
